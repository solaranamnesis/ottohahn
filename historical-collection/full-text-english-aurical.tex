...
\usepackage{csquotes}
\makeindex[columns=2, title=\Fontauri{Alphabetical Index}, intoc]
...
\clearpage
\Large
\section{\Fontauri{Foreword}}
\subsection{\Fontauri{``Fossil Organisms in Meteorites,'' by George W. Rachel}}
\paragraph*{}
...
It is the latter, the siliceous material, which has been examined with such remarkable results by Dr. Hahn. This occurs usually in light-colored spherical or pear-shaped masses (χονδροι [chondroi]) similar to the nests of crystals (druses) which are a well-known occurrence in crystalline rocks. These peculiar forms consist principally of bronzite and enstatite\index{enstatite}, which to the naked eye show an appearance graphically described by Kesselmayer twenty years ago.

Professor [Carl Wilhelm von] Gümbel\index{Gümbel}, of Munich, in a report made to the Royal Bavarian Academy of Sciences has described them, on the basis of Kesselmayer's book and his own researches, as follows:
...
One of the corals is set down by various observers a resembling to the \emph{Favosites goldfussi} from the Silurian\index{Silurian} \emph{Grauwacke},\footnote{\Fontauri{A drawing of this fossil\index{fossil} coral\index{coral} is given by Dana in his \emph{Textbook on Geology}, Ed. 1868, p. 111.}} another is compared to the \emph{Calamopora naumanni} from the same strata.
...
Referring to this discovery, Friedrich Mohr wrote,\footnote{\Fontauri{\emph{Geschichte der Erde}, 1866, p. 500.}} sixteen years ago:
...
\clearpage
\subsection{\Fontauri{``Mr. Darwin on Dr. Hahn's Discovery of Fossil Organisms in Meteorites,'' by G. W. Rachel}}
\paragraph*{}
...
\clearpage
\section{\Fontauri{\emph{The Meteorite (Chondrite) and its Organisms}, by Otto Hahn}}
\subsection{\Fontauri{Introduction}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{History and Overview}}
Δός μοι χέντρον%Δός μοι χέντρον
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{Previous Views on the Meteorites\index{meteorite}}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{Meteorites\index{meteorite} and their Mineralogical Properties}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{The Organic Nature of the Chondrite\index{chondrite!organic}}}
\subsubsection{\Fontauri{Organic or Inorganic?}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{The Individual Forms: Sponges --- \emph{Urania}\index{Urania}}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{The Individual Forms: Sponges --- Needle Sponges\index{sponge}}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{The Individual Forms: Corals\index{coral}}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{The Individual Forms: Crinoids\index{crinoid}}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{Stone in the Stone}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{Reproduction}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{Development}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{The Iron Meteorites\index{meteorite!iron}}}
\paragraph*{}
...
\end{enumerate}
\paragraph*{}
But now I am well by uniting with a revered friend, Professor Dr. H. [Gustav Karl Wilhelm Hermann] Karsten\index{Karsten} in Schaffhausen, who presently is in a position to furnish evidence for the transformation of plants into iron. Karsten has already proven in the year 1869 that our lowest plants absorb iron through entirely outstanding means; I owe the iron plants of today to his kindness. With his permission I include an excerpt from his excellent work, \emph{The Chemistry of Plant Cells}, Vienna\index{Vienna} 1869, p. 53, which here follows:
...
\clearpage
\subsection{\Fontauri{The Iron of Ovifak\index{Ovifak}}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{Conclusions}}
\subsection{\Fontauri{The Origin of Meteorites\index{meteorite!origin}}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{The Formation of the Earth\index{Earth}}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{The Future of Our Planet}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{Explanation of the Tables}}
\subsection{\Fontauri{Preliminary Note}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{Table Index}}
\begin{enumerate}
...
\pagestyle{fancy}
\fancyhf{}
\rhead{\Fontauri{Table 1: Mineral structures along with organic ones from the chondrites\index{chondrite}}}
\cfoot{\Fontauri{\thepage}}
\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_1-1_edit-b2.jpg}
\caption{\Fontauri{Table 1: Figure 1 --- Enstatite\index{enstatite} (Bronzite)\index{bronzite} from Kupferberg\index{Kupferberg} M.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_1-2_edit-b.jpg}
\caption{\Fontauri{Table 1: Figure 2 --- Enstatite\index{enstatite} from Texas\index{Texas} M.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_1-3_edit-b2.jpg}
\caption{\Fontauri{Table 1: Figure 3 --- Spherulite-Liparite\index{spherulite} from Lipari M.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_1-4_edit-b.jpg}
\caption{\Fontauri{Table 1: Figure 4 --- A part of the coral\index{coral} from Table 8, 9, and 10}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_1-5_edit-b2.jpg}
\caption{\Fontauri{Table 1: Figure 5 --- Chain coral\index{coral} D. 0.90 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_1-6_edit-b2.jpg}
\caption{\Fontauri{Table 1: Figure 6 --- Crinoid\index{crinoid} D. 1.20 mm.}}
\centering
\end{figure}
\clearpage
\rhead{\Fontauri{Table 2: \emph{Urania}\index{Urania}}}
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_2-1_edit-b2.jpg}
\caption{\Fontauri{Table 2: Figure 1 --- Knyahinya\index{meteorite!Knyahinya}, same as Table 5: Figure 1.}}
\centering
\end{figure}
\clearpage
\rhead{\Fontauri{Table 3: \emph{Urania}\index{Urania}}}
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_3-1_edit-b.jpg}
\caption{\Fontauri{Table 3: Figure 1 --- Knyahinya\index{meteorite!Knyahinya} D. 0.60 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_3-2_edit-b.jpg}
\caption{\Fontauri{Table 3: Figure 2 --- Knyahinya\index{meteorite!Knyahinya} D. 1.30 mm. (do not overlook the magnificent crinoid\index{crinoid} limbs on the top left!)}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_3-3_edit-b.jpg}
\caption{\Fontauri{Table 3: Figure 3 --- Knyahinya\index{meteorite!Knyahinya} D. 1 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_3-4_edit-b.jpg}
\caption{\Fontauri{Table 3: Figure 4 --- Knyahinya\index{meteorite!Knyahinya} D. 1 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_3-5_edit-b2.jpg}
\caption{\Fontauri{Table 3: Figure 5 --- Knyahinya\index{meteorite!Knyahinya} D. 1 mm. (notice the stratification at the top)}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_3-6_edit-b2.jpg}
\caption{\Fontauri{Table 3: Figure 6 --- Knyahinya\index{meteorite!Knyahinya} D. 1 mm. (Stratification like 5, but not reproduced in the image, 5 and 6 of a thin section)}}
\centering
\end{figure}
\clearpage
\rhead{\Fontauri{Table 4: \emph{Urania}\index{Urania}}}
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_4-1_edit-b.jpg}
\caption{\Fontauri{Table 4: Figure 1 --- Knyahinya\index{meteorite!Knyahinya} D. 0.90 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_4-2_edit-b.jpg}
\caption{\Fontauri{Table 4: Figure 2 --- Siena\index{meteorite!Siena} D. 3 mm. (the dark line is due to the yellow color of the preparation)}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_4-3_edit-b.jpg}
\caption{\Fontauri{Table 4: Figure 3 --- Knyahinya\index{meteorite!Knyahinya} D. 0.60 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_4-4_edit-b.jpg}
\caption{\Fontauri{Table 4: Figure 4 --- Knyahinya\index{meteorite!Knyahinya} D. 0.90 mm. (air bubble)}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_4-5_edit-b.jpg}
\caption{\Fontauri{Table 4: Figure 5 --- Knyahinya\index{meteorite!Knyahinya} D. 1.60 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_4-6_edit-b.jpg}
\caption{\Fontauri{Table 4: Figure 6 --- Knyahinya\index{meteorite!Knyahinya} D. 1.00 mm. (air bubble)}}
\centering
\end{figure}
\clearpage
\rhead{\Fontauri{Table 5: \emph{Urania}\index{Urania}}}
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_5-1_edit-b.jpg}
\caption{\Fontauri{Table 5: Figure 1 --- Knyahinya\index{meteorite!Knyahinya} D. 1.40 mm. (see Table 2. All around average crinoid\index{crinoid}. Form bottom left, magnification. Table 1: Figure 6 and Table 25: Figures 1 and 2)}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_5-2_edit-b2.jpg}
\caption{\Fontauri{Table 5: Figure 2 --- Knyahinya\index{meteorite!Knyahinya} D. 1.80 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_5-3_edit-b.jpg}
\caption{\Fontauri{Table 5: Figure 3 --- Knyahinya\index{meteorite!Knyahinya} D. 1.80 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_5-4_edit-b.jpg}
\caption{\Fontauri{Table 5: Figure 4 --- Knyahinya\index{meteorite!Knyahinya} D. 1.30 mm. (blurred picture)}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_5-5_edit-b2.jpg}
\caption{\Fontauri{Table 5: Figure 5 --- Knyahinya\index{meteorite!Knyahinya} D. 1.40 mm. (air bubble)}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_5-6_edit-b2.jpg}
\caption{\Fontauri{Table 5: Figure 6 --- Knyahinya\index{meteorite!Knyahinya} D. 0.60 mm. (poor picture. The white circle is the average)}}
\centering
\end{figure}
\clearpage
\rhead{\Fontauri{Table 6: \emph{Urania}\index{Urania}}}
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_6-1_edit-b2.jpg}
\caption{\Fontauri{Table 6: Figure 1 --- Siena\index{meteorite!Siena} D. 4.00 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_6-2_edit-b.jpg}
\caption{\Fontauri{Table 6: Figure 2 --- Knyahinya\index{meteorite!Knyahinya} D. 0.80 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_6-3_edit-b.jpg}
\caption{\Fontauri{Table 6: Figure 3 --- Siena\index{meteorite!Siena} D. 1.20 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_6-4_edit-b.jpg}
\caption{\Fontauri{Table 6: Figure 4 --- Knyahinya\index{meteorite!Knyahinya} D. 0.70 mm. (the center is heavily illuminated)}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_6-5_edit-b.jpg}
\caption{\Fontauri{Table 6: Figure 5 --- Knyahinya\index{meteorite!Knyahinya} D. 0.30 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_6-6_edit-b2.jpg}
\caption{\Fontauri{Table 6: Figure 6 --- Knyahinya\index{meteorite!Knyahinya} D. 0.90 mm. (air bubble)}}
\centering
\end{figure}
\clearpage
\rhead{\Fontauri{Table 7: Sponges}}
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_7-1_edit-b.jpg}
\caption{\Fontauri{Table 7: Figure 1 --- Knyahinya\index{meteorite!Knyahinya} D. 2.30 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_7-2_edit-b.jpg}
\caption{\Fontauri{Table 7: Figure 2 --- Knyahinya\index{meteorite!Knyahinya} D. 1.80 mm. (a crack in the preparation. Needle)}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_7-3_edit-b.jpg}
\caption{\Fontauri{Table 7: Figure 3 --- Knyahinya\index{meteorite!Knyahinya} D. 2.10 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_7-4_edit-b.jpg}
\caption{\Fontauri{Table 7: Figure 4 --- (Crinoid\index{crinoid} cross section?) of Knyahinya\index{meteorite!Knyahinya} D. 3.00 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_7-5_edit-b.jpg}
\caption{\Fontauri{Table 7: Figure 5 --- Sponge? D. 1.00 mm.\index{sponge}}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_7-6_edit-b.jpg}
\caption{\Fontauri{Table 7: Figure 6 --- Sponge? D. 2.40 mm.\index{sponge}}}
\centering
\end{figure}
\clearpage
\rhead{\Fontauri{Table 8: Corals}}
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_8-1_edit-b2.jpg}
\caption{\Fontauri{Table 8: Figure 1 --- (\emph{Favosites}\index{Favosites}) of Knyahinya\index{meteorite!Knyahinya} (see Table 1: Figure 4)}}
\centering
\end{figure}
\clearpage
\rhead{\Fontauri{Table 9: Corals}}
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_9-1_edit-b3.jpg}
\caption{\Fontauri{Table 9: Figure 1 --- Structure picture from top left of Table 8.}}
\centering
\end{figure}
\clearpage
\rhead{\Fontauri{Table 10: Corals}}
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_10-1_edit-b.jpg}
\caption{\Fontauri{Table 10: Figure 1 --- Knyahinya\index{meteorite!Knyahinya} cross section D. 0.40 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_10-2_edit-b.jpg}
\caption{\Fontauri{Table 10: Figure 2 --- Longitudinal section 0.50 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/meteorite_10-3_edit-b2.jpg}
\caption{\Fontauri{Table 10: Figure 3 --- Knyahinya\index{meteorite!Knyahinya} D. 1.80 mm.}}
\centering
\end{figure}
\clearpage
\begin{figure}[t]
...
\rhead{}
\cfoot{\Fontauri{\thepage}}
\section{\Fontauri{``Corals in the Meteorites,'' by David Friedrich Weinland}}
\paragraph*{}
...
\clearpage
\section{\Fontauri{``About the `Organisms of the Meteorite,''' by Anton Rzehak}}
\paragraph*{}
...
Brünn, April 25, 1881.
\clearpage
\section{\Fontauri{``More About the Animal Remains in the Meteorites,'' by D. F. Weinland}}
\paragraph*{}
...
Dr. Otto Hahn
\clearpage
\section{\Fontauri{``Yet Again the `Organisms of the Meteorite,''' by A. Rzehak}}
\paragraph*{}
...
Brünn, July 1881.
\clearpage
\section{\Fontauri{\emph{The Meteorite and its Organisms}, by Hermann Karsten}}
\paragraph*{}
...
\rhead{}
\cfoot{\Fontauri{\thepage}}
\section{\Fontauri{\emph{About the Animal Remains Discovered in the Meteorites}, by D. F. Weinland}}
\subsection*{\Fontauri{Introduction}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{``Little Grated Creatures,'' Polycystina}}
\subsubsection{\Fontauri{\emph{Phormiscus}. Nov. gen.}}
\paragraph*{}
(φορμισκος = ``little reed basket'')%φορμισxος
...
\paragraph{\large\Fontauri{\emph{Phormiscus vulgaris}. N. sp.}}
\subparagraph{}
...
\paragraph{\large\Fontauri{\emph{Phormiscus grandis}. N. sp.}}
\subparagraph{}
...
\subsubsection{\Fontauri{\emph{Thyriscus}. Nov. gen.}}
\paragraph*{}
...
\paragraph{\large\Fontauri{\emph{Thyriscus formosus}. N. sp.}}
\subparagraph{}
...
\subsubsection{\Fontauri{\emph{Goniobrochus}. Nov. gen.}}
\paragraph*{}
...
\paragraph{\large\Fontauri{\emph{Goniobrochus haeckelii}. N. sp.}}
\subparagraph{}
...
\clearpage
\subsection{\Fontauri{Sponges and Foraminifera}}
\subsubsection*{\Fontauri{Family: Uranidae. \emph{Nobis}.}}
\paragraph*{}
...
\subsubsection{\Fontauri{\emph{Urania}, Hahn (\emph{sensu stricto}).}}
\paragraph*{}
...
\paragraph{\large\Fontauri{\emph{Urania salve}. N. sp.}}
\subparagraph{}
...
\subsubsection{\Fontauri{\emph{Pectiscus}. Nov. gen.}}
\paragraph*{}
...
\paragraph{\large\Fontauri{\emph{Pectiscus zittelii}. N. sp.}}
\subparagraph{}
...
\caption{\Fontauri{Figure 1: \emph{Pectiscus}. Magnified 80 times.}}
\end{figure}
\paragraph*{}
...
\paragraph{\large\Fontauri{\emph{Pectiscus rudis}. N. sp.}}
\subparagraph{}
A smaller form with even coarser slats.
\subsubsection{\Fontauri{\emph{Callaion}. Nov. gen.}}
\paragraph*{}
...
\paragraph{\large\Fontauri{\emph{Callaion paulinianum}. N. sp.}}
\subparagraph{}
...
\subsubsection{\Fontauri{\emph{Glossiscus}. Nov. gen.}}
\paragraph*{}
...
\paragraph{\large\Fontauri{\emph{Glossiscus schmidtii}. N. sp.}}
\subparagraph{}
...
\subsubsection{\Fontauri{\emph{Carydion}. Nov. gen.}}
\paragraph*{}
(κάρυον = ``nut'')%κάρυον
...
\paragraph{\large\Fontauri{\emph{Carydion solidum}. N. sp.}}
\subparagraph{}
...
\subsubsection{\Fontauri{\emph{Brochosphaera}. Nov. gen.}}
\paragraph*{}
...
\paragraph{\large\Fontauri{\emph{Brochosphaera grandis}. N. sp.}}
\subparagraph{}
...
\paragraph{\large\Fontauri{\emph{Brochosphaera hexagonalis}. N. sp.}}
\subparagraph{}
...
\subsubsection{\Fontauri{\emph{Dicheliscus}. Nov. gen.}}
\paragraph*{}
...
\paragraph{\large\Fontauri{\emph{Dicheliscus uva}. N. sp.}}
\subparagraph{}
...
\subsubsection{\Fontauri{Other forms}}
\paragraph*{}
...
\clearpage
\subsection{\Fontauri{Corals}}
\subsubsection{\Fontauri{\emph{Hahnia}. Nov. gen.}}
\paragraph*{}
...
\caption{\Fontauri{Figure 2: \emph{Hahnia meteoritica}, N., attached to a \emph{Pectiscus}. Magnified 80 times.}}
\end{figure}
\paragraph*{}
...
\subsubsection{\Fontauri{\emph{Calamiscus}. Nov. gen.}}
\paragraph*{}
(καλαμίσκςί = ``little tubes'')%kαλαμίσxς
...
\paragraph{\large\Fontauri{\emph{Calamiscus gümbelii}. N. sp.}}
\subparagraph{}
...
\subsubsection{\Fontauri{\emph{Bosea}. Nov. gen.}}
\paragraph*{}
...
\paragraph{\large\Fontauri{\emph{Bosea cyanea}. Nov. sp.}}
\subparagraph{}
...
\clearpage
\subsection{\Fontauri{\emph{Crinoidea}}}
\paragraph*{}
...
\subsubsection{\Fontauri{\emph{Eulophiscus}. Nov. gen.}}
\paragraph*{}
...
\paragraph{\large\Fontauri{\emph{Eulophiscus quenstedtii}. N. sp.}}
\subparagraph{}
...
Comes from the meteorite fall of Knyahinya.\index{meteorite!Knyahinya}
\paragraph{\large\Fontauri{\emph{Euplocamus articulatus}. N. sp.}}
\subparagraph{}
...
\subsubsection{\Fontauri{\emph{Crobyliscus}. Nov. gen.}}
\paragraph*{}
(κρὠβυλος = ``knot'')%xρὠβυλος
...
\paragraph{\large\Fontauri{\emph{Crobyliscus fraasii}. N. sp.}}
\subparagraph{}
...
\clearpage
\subsection{\Fontauri{Conclusion}}
\paragraph*{}
...
\clearpage
\section{\Fontauri{\emph{The Alleged Organisms of the Meteorites}, by Carl Vogt}}
\paragraph*{}
...
\pagestyle{fancy}
\fancyhf{}
\rhead{\Fontauri{Explanation of the Figures}}
\cfoot{\Fontauri{\thepage}}
\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/vogt/Fig1.png}
\caption{\Fontauri{Figure 1: Cross section of a real coral\index{coral} branch (\emph{Seriatopora caliendrum} Ehrenberg): \emph{a}, longitudinal channel of the main branch. --- \emph{b}, \emph{c}, \emph{d}, cells cut at different heights. --- \emph{e}, burgeoning channel. On the tips, we see two arrangements of crystals, in plumes and in meshes. Magnification 100 diameters. Figure 1a. --- Grouping of the crystals in meshes with edges. Magnification 500.}}
\centering
\end{figure}
\clearpage
\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/vogt/Fig2.png}
\caption{\Fontauri{Figure 2: Hahnian crinoid\index{crinoid} from the Vouillé meteorite. Magnification 50. One sees the point of departure of the branched, articulated, radiating columns, often slightly curved and the cortical zone, displaying a very fine and close mesh design. Grains and splinters of meteoritic iron are dispersed throughout the mass.}}
\centering
\end{figure}
\clearpage
\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/vogt/Fig3.png}
\caption{\Fontauri{Figure 3: \emph{Pentacrinus europaeus}. Magnification 50. In order to point out the reticular structure specific to all the pieces of the skeleton, composing the stem, the calyx, and the budding arms.}}
\centering
\end{figure}
\clearpage
\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/vogt/Fig4.png}
\caption{\Fontauri{Figure 4: Crystals imitating algae\index{algae} filaments in a diorite of the Leith River near Edinburgh. Magnification 180. These crystals are hexahedral prisms; the shadow of the ribbing produces in some of them longitudinal features simulating channels. In others, we see genuine medial channels with pockets of air or empty bubbles arranged along the axis.}}
\centering
\end{figure}
\clearpage
\begin{figure}[b]
...
\caption{\Fontauri{Figure 5: A crystal obtained from the Knyahinya meteorite\index{meteorite!Knyahinya} by treatment with acids. Magnification 300. We see fractures filled by a rarified encrusting substance and on one of the ends articulated pieces affixed in a columnar arrangement.}}
\end{figure}
\clearpage
\begin{figure}[b]
\centering
\includegraphics[keepaspectratio]{figures/vogt/Fig6.png}
\caption{\Fontauri{Figure 6: Splinter from Knyahinya\index{meteorite!Knyahinya}, treated with potash, having a columnar and articulated disposition. Magnification 300. Crossed polars.}}
\end{figure}
\clearpage
\begin{figure}[b]
\centering
\includegraphics[keepaspectratio]{figures/vogt/Fig7.png}
\caption{\Fontauri{Figure 7: A crystal dislocated from Knyahinya\index{meteorite!Knyahinya}. Magnification 300. The encrusting material penetrates everywhere and fills the small cavities of the surface.}}
\end{figure}
\clearpage
\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/vogt/Fig8.png}
\caption{\Fontauri{Table 2: Figure 8 --- A group of large crystals in a thin section of the Vouillé meteorite. Magnification 180. There are some large clumps of meteoritic iron. The opaque encrusting material fills all the interstices.}}
\centering
\end{figure}
\clearpage
\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/vogt/Fig9.png}
\caption{\Fontauri{Table 2: Figure 9 --- Very thin section of the artificial enstatite\index{enstatite} produced by Mr. Daubrée through the fusion of peridot with iron. There is a large, almost circular, obtusely angled gap left by a removed crystal. Iron fills the interstices. Magnification 180.}}
\centering
\end{figure}
\clearpage
\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/vogt/Fig10.png}
\caption{\Fontauri{Table 2: Figure 10 --- Thicker cut of the same artificial enstatite\index{enstatite}. Magnification 180.}}
\centering
\end{figure}
\clearpage
\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/vogt/Fig11.png}
\caption{\Fontauri{Table 3: Figure 11 --- Transparent chondrule from the Vouillé meteorite showing a finely striated structure. A dislocated piece \emph{c} displays a columnar structure. --- \emph{a}, A tubiform filling of a fracture, isolated. Magnification 100. --- \emph{b}, The extremity of a tube formed by the encrusting material, bringing to light the channel. Magnification 500.}}
\centering
\end{figure}
\clearpage
\rhead{\Fontauri{Fragments of chondrules from Knyahinya\index{meteorite!Knyahinya}, treated with acids. Magnification 300.}}
\begin{figure}[b]
\centering
\includegraphics[keepaspectratio]{figures/vogt/Fig12.png}
\caption{\Fontauri{Figure 12: Larger crystals, on which smaller crystals are laid out.}}
\end{figure}
\clearpage
\begin{figure}[b]
\centering
\includegraphics[keepaspectratio]{figures/vogt/Fig13.png}
\caption{\Fontauri{Figure 13: Portion of an Hahnian coral\index{coral}; articulated columnar layout.}}
\end{figure}
\clearpage
\begin{figure}[b]
\centering
\includegraphics[keepaspectratio]{figures/vogt/Fig14.png}
\caption{\Fontauri{Figure 14: Arms of an Hahnian crinoid\index{crinoid}; articulated and branched layout.}}
\end{figure}
\clearpage
\begin{figure}[b]
\centering
\includegraphics[keepaspectratio]{figures/vogt/Fig15.png}
\caption{\Fontauri{Table 2: Figure 15 --- Columnar and parallel disposition of crystals eroded and marked by encrusting opaque material.}}
\end{figure}
\clearpage
\rhead{\Fontauri{Explanation of the Figures}}
\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/vogt/Fig16.png}
\caption{\Fontauri{Figure 16: Thin section of enstatite\index{enstatite} produced by Mr. Daubrée by melting lherzolite with iron. Radiant fibers in fields circumscribed by crystalline rods. Magnification 50.}}
\centering
\end{figure}
\clearpage
\begin{figure}[b]
...
\caption{\Fontauri{Figures 17 and 18 --- Two of these rods. Magnification 500. On one of these rods one sees figures resembling pore protuberances or lamina scars; on the other, pieces resembling crampons.}}
\end{figure}
\begin{figure}[b]
\centering
...
\clearpage
\subsubsection{\Fontauri{Stone Mass}}
\paragraph*{}
...
\caption{\Fontauri{Table 1: Drawing of Iowa meteorite thin section at 25 times magnification.}}
\end{figure}
...
The part\footnote{\Fontauri{These analyses were performed by assistant Mr. Adolf Schwager. (Math.-Phys. Class. 3. 1875.)}} decomposable in hydrochloric acid (calculated without meteoritic and sulphuric iron) is made of
\begin{center}
    \begin{tabular}{ |l|r|r| } 
    \hline
...
\end{center}
\paragraph*{}
The rest, undecomposed in hydrochloric acid, consists of\footnote{\Fontauri{\emph{ibid}.}}
\begin{center}
    \begin{tabular}{ |l|r|r| } 
    \hline
...
Among the chondrites analyzed up till now, it is only that of Tadjera\index{meteorite!Tadjera} with a similar composition,\footnote{\Fontauri{[Carl] Rammelsberg, \emph{The Chemical Nature of the Meteorites}, p. 157.}} though poorer in silicon dioxide and richer in calcium oxide.
...
\end{enumerate}
\clearpage
\subsection{\Fontauri{``About the Stone Meteorites Found in Bavaria,'' by Carl Wilhelm von Gümbel}}
\subsubsection*{\Fontauri{Introduction}}
\paragraph*{}
...
\begin{enumerate}
    ...
    \item still other tiny kernels of a white and yellow color that are translucent and shimmering. According to his analysis, the meteoritic stone is comprised of:\footnote{\Fontauri{Numbers in tables are in percentages, unless otherwise specified.}}
\end{enumerate}
\begin{center}
    \begin{tabular}{l r} 
...
So that the chemical analysis was correct as well, the gentleman assistant Adolf Schwager was separately supervising examinations conducted at the same time. The measurement of the meteoritic and ferrous sulfide was done through individual experiments.\footnote{\Fontauri{Anything extractable was taken out of the crushed powder with the magnet and these component parts containing meteoritic iron were specially analyzed with the application of copper vitriol and copper chloride.}} The analyses yielded:
\begin{center}
...
\clearpage
\subsubsection{\Fontauri{The Meteoritic Stone from Eichstädt}}
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, scale=2]{figures/gumbel/bayern/Fig-2.png}
\caption{\Fontauri{Figure 2: Thin section of the Meteoritic Stone from Eichstädt.}}
\end{figure}
\paragraph*{}
...
The specific weight\footnote{\Fontauri{Compare with [Carl von] Moll's \emph{Annals of Orography and Metallurgy}, Vol. 3, p. 251.}} is given:
\begin{center}
    \begin{tabular}{l r}
...
\clearpage
\subsubsection{\Fontauri{The Meteoritic Stone from Massing}}
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, scale=2]{figures/gumbel/bayern/Fig-3.png}
\caption{\Fontauri{Figure 3: Thin section of the Meteoritic Stone from Massing.}}
\end{figure}
\paragraph*{}
About the nearby circumstances of the fall of these meteorites, Professor Imhof (\emph{Bavarian Electoral Palatinate Weekly Paper}, 1804, p. 3 and following)\footnote{\Fontauri{Gilbert's \emph{Annals of Physics}, 18, p. 330.}} shares:
...
\clearpage
\subsubsection{\Fontauri{The Meteoritic Stone from Schönenberg}}
\begin{figure}[H]
\centering
\includegraphics[keepaspectratio, scale=2]{figures/gumbel/bayern/Fig-4.png}
\caption{\Fontauri{Figure 4: Thin section of the Meteoritic Stone from Schönenberg.}}
\end{figure}
\paragraph*{}
...
The fusion crust is, according to my perception, dully shimmering, black, and in places where the iron particles exist in proximity, quite thick (up to 0.5 millimeter). The light gray, white, finely granulated, sparsely dotted black, rust-stained in patches, main mass is comprised, insofar as this provisional determination allows, out of:
\begin{enumerate}
...
\subsubsection{\Fontauri{The Meteoritic Stone from Krähenberg}}
...
Microscopically, unusual, admixed components are still found of extraordinarily small, crimson crystal pieces, quite a few intensely yellow granules with noticeable crystal faces, some light yellow, oblong prismatic forms and, finally, distinct, up to 0.5 millimeter large, red granules with conchoidal breakage that are translucent --- likely a decomposition product of the ferrous sulfide, similar to \emph{caput mortuum} [\emph{crocus metallorum}].
...
I encountered partially similar views, to which my study of the chondrites led, even with [Henry Clifton] Sorby, who had in the past already indicated this in the essay: ``On the Physical History of Meteorites.''\footnote{\Fontauri{\emph{The Geological Magazine}, 2, 1865, p. 447.}}
...
\clearpage
\subsection{\Fontauri{``Are the Chondrites Petrified Organic Debris?'' by Solar Anamnesis}}
\paragraph*{}
...
\begin{displayquote}
``There is nothing to be found in the rock of glass or lava-like additions (with the exception of the fusion crust). It is not a crystalline rock that solidified from a melt flow, but rather a clastic rock, the aggregate particles of which do not have the properties of volcanic ash.''\footnote{\Fontauri{\emph{Über die Beschaffenheit des Steinmeteoriten vom Fall am 12. Februar 1875 in der Grafschaft Iowa Nordamerika}, Gümbel, 1875.}} And ``...there is no trace of lava- or slag-like admixtures nor binding agents; all slagging that is found is only secondary phenomena resulting from the movement of the meteorite within the terrestrial atmosphere...''\footnote{\Fontauri{\emph{Über die in Bayern gefundenen Steinmeteoriten}, Gümbel, 1878.}}
\end{displayquote}
\paragraph*{}
In 1880 Dr. Otto Hahn published \emph{The Meteorite (Chondrite) and its Organisms}, which built on Gümbel's clastic observations by concluding that much of the chondritic material appeared to have an organic origin and that the globules of the chondrites were being mistaken for igneous glass, when they were in fact the petrification products of diverse anatomical \emph{débris}.\footnote{\Fontauri{\emph{Die Meteorite (Chondrite) und ihre Organismen}, Hahn, 1880.}} Part of Hahn's goal was to sort the organic \emph{débris} from the inorganic. Hahn stated that if and only if all five of the following conditions were fulfilled could he declare an observed form as being organic:
\begin{enumerate}
    \item a closed form,
    \item a recurring form,
    \item recurring in developmental stages,
...
\begin{displayquote}
``The forms of the creatures so far recognized in the chondrites are all associated with water; the whole mass of these meteorites seems to have been built underwater, the countless microscopic organisms either petrified retroactively or, more likely based on the chemical analysis of these bodies, combined in their own way with the mineral substances dissolved in this water and assimilated the same, similar to how present-day mussels, corals, \emph{Bacillaria}, \emph{Equiseten}, and various Vibrionaceae skins silicify and calcify in a similar manner to the bones of vertebrates. Ultimately, they were cemented together by the dried-up reside of the silica rich nutrient liquid into a coherent silica rock mass. One also sees, therefore, countless small translucent and transparent organizations --- at least in the Knyahinya meteorite\index{meteorite!Knyahinya} --- heaped one upon another, and this makes it very difficult to recognize the actual form of most of them, since their presence, even to those who are familiar with microscopic organic forms, is difficult to perceive, especially being unfamiliar forms.''\footnote{\Fontauri{\emph{Die Meteorite und ihre Organismen}, Karsten, 1881.}}
\end{displayquote}
\paragraph*{}
Anton Rhezak, open to the idea that meteorites could contain organic material, but skeptical of Hahn's claims, stated that there are no known terrestrial enstatite\index{enstatite} rocks that exhibit the forms seen in the chondrites, in addition to the fact that there are non-chondritic types of meteorites composed of enstatite which do match quite well with terrestrial enstatite specimens.\footnote{\Fontauri{\emph{Das Ausland}, Article 5, Vol. 20, 1881.}} Yet, Rhezak provided no alternative other than that resorted to by researchers of his day: the theory of patterns of encrusted material in glass. He stated that a single organic specimen found in the chondrites would be a counterexample to the entire theory of glass as the explanation for the forms of the chondrites. He based his entire opposition to Hahn and Weinland on a single meteorite with only a few cuts and fragments.\footnote{\Fontauri{\emph{Das Ausland}, Article 4, Vol. 37, 1881.}}

Dr. Carl Vogt, in 1882, wrote a lengthy essay: \emph{The Alleged Organisms of the Meteorites}, which included hand drawn illustrations, in an attempt to disprove Hahn's theory by proving that the forms of chondrites could easily be reproduced synthetically. He took the side of the opponents who claimed that the chondrules were inorganic glass crystallizations with a kind of encrusting material -- readily produced by artificial means through the melting of the chondritic material. Vogt provided several illustrations showing such artificially produced chondritic material and patterns.\footnote{\Fontauri{\emph{Les Prétendus Organismes des Météorites}, Vogt, 1882.}} But if Vogt and his colleagues had artificially created the chondrites, then how could they have remained a mystery until the modern time? Studying Vogt's work and illustrations reveals that he either did not address or was not aware of the more interesting and peculiar features of the chondrites.

No further work was published to support Hahn, Weinland, and Karsten\index{Karsten} after 1881 and they were apparently forgotten by history. In the intervening years there has been little to no mention of their organic theory. In 1916 Dr. Randolph Kirkpatrick stated in his \emph{Nummulosphere} that the chondrites were fossiliferous -- although he rejected Hahn because Hahn had not gone far enough in his conclusions.\footnote{\Fontauri{\emph{Nummulosphere}, Kirkpatrick, 1916.}} Dr. George P. Merrill stated in 1920 that some of the chondrites resembled the products of slag but he also pointed out problems with this comparison.\footnote{\Fontauri{\emph{On Chondrules and Chondritic Structure in Meteorites}, Merrill, 1920.}} In 1961 Drs. Claus and Nagy published a paper detailing at least five types of ``organized elements'' within various carbonaceous chondrites.\footnote{\Fontauri{Claus, G., and Nagy, B., \emph{Nature}, 192, 594 (1961).}}

In the 1950's Sir Fred Hoyle proposed that interstellar dust clouds could be composed of freeze dried bacteria based on light spectrum observations.\footnote{\Fontauri{\emph{Evolution from Space: A Theory of Cosmic Creationism}, Hoyle, 1984.}} Dr. Chandra Wickramasinghe continued and expanded the work of Hoyle and wrote numerous books in support of the theory of panspermia.\footnote{\Fontauri{\emph{The Search for our Cosmic Ancestry}, Wickramasinghe, 2015.}} In recent times, Dr. Richard B. Hoover has found microscopic evidence of organic structures, including cyanobacteria and diatoms, in carbonaceous chondrites.\footnote{\Fontauri{``Microfossils of Cyanobacteria in the Orgueil\index{meteorite!Orgueil} Carbonaceous Meteorite,'' Hoover, 2011.}}
...
\caption{\Fontauri{Figure 1: Observations of spicules, feather type patterns within a secondary material inside a single ellipsoid inclusion of perfectly clear olivine\index{olivine} with additional bubble trails in curious locations. Northwest Africa 2892.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 2: Higher magnification view of Figure 1.}}
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig2a.png}
\caption{\Fontauri{Figure 3: Cropped section from Figure 2.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 4: Sharp, barbed spicules similar to some radiolarians, a unique grated oval structure attached to an appendage. Northwest Africa 11344.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 5: Higher magnification view of Figure 4 showing spicules.}}
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 6: Cropped image of Figure 5.}}
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig2.jpg}
\caption{\Fontauri{Figure 7: Resembles Figure 1 in Table 8 of Hahn's work and Figure 1 of Karsten's\index{Karsten} work. Northwest Africa 2892.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 8: Numerous parallel and crossing tubular structures from Figure 7.}}
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig32.jpg}
\caption{\Fontauri{Figure 9: Numerous parallel and curved tubular structures from Figure 7.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 10: Interesting patterns. Northwest Africa 4910.}}
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 11: Greyish secondary material in peculiar patterns within the chondrule.}}
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 12: Feathery, skeletal looking forms. Northwest Africa 8773.}}
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig5.jpg}
\caption{\Fontauri{Figure 13: Skeletal looking forms. Saratov.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 14: Interesting patterns with spicules at high magnification. Saratov.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 15: Two fascinating forms in cross polarized light. Northwest Africa 5930.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 16: Higher magnification view of leftmost structure in Figure 15.}}
\centering
\end{figure}

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig10.jpg}
\caption{\Fontauri{Figure 17: Higher magnification view of rightmost structure in Figure 15.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 18: Interesting structure similar to those in Figure 15. Northwest Africa 5930.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 19: Higher magnification view of rightmost structure in Figure 18.}}
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 20: Curious structure in Allende.}}
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig14.jpg}
\caption{\Fontauri{Figure 21: Higher magnification view of Figure 20.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 22: Fascinating inclusion with crossing. Northwest Africa 2224.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 23: Characteristic pattern form. Northwest Africa 2224.}}
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig30.jpg}
\caption{\Fontauri{Figure 24: Characteristic pattern form. Northwest Africa 11344.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 25: Arrangement of structures in Aba Panu similar to Figure 2 of Weinland's 1882 work.}}
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig17.jpg}
\caption{\Fontauri{Figure 26: Surface photo showing inclusion with peculiar characteristics. Northwest Africa 6472.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 27: Higher magnification view of Figure 26.}}
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig26.jpg}
\caption{\Fontauri{Figure 28: Surface photo showing pacman type characteristics. Northwest Africa 6472.}}
\centering
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 29: Surface photo showing inclusion with bilaterally symmetric shape. Northwest Africa 6472.}}
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 30: Surface photo showing peculiar characteristics. Northwest Africa 2224.}}
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 31: High magnification view of a carbonaceous inclusion. Kainsaz.}}
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 32: Triangular shaped inclusion with grated mouth hole resembling sea urchin larva structure. Northwest Africa 4910.}}
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 33: High magnification view of a carbonaceous inclusion containing interesting diatom-like patterns. Moss.}}
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 34: High magnification view of a carbonaceous inclusion containing interesting patterns. Kainsaz.}}
\end{figure}
\clearpage
...
\caption{\Fontauri{Figure 35: A unicum, this inclusion contained forms and structures that were characteristically different than most. Northwest Africa 2224.}}
\end{figure}
\clearpage
\pagestyle{fancy}
\fancyhf{}
