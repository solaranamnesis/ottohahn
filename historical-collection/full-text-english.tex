...
Other meteorites containing organic substances have been recorded since then. Thus at Orgueil, France, 1864; at Knyahinya\index{meteorite!Knyahinya}, Hungary, June 9, 1866. This phenomenon is the most important since very many of the most convincing specimens, prepared by Dr. Hahn, have been obtained from a stone weighing 27 lbs., which formed part of the 600 lbs. that fell in that particular locality on that day.
...
They all agree that the chondrites\index{chondrite!composition} consist of a matrix of spheres of enstatite\index{enstatite} (bronzite\index{bronzite}), olivine\index{olivine}, iron, nickel and chromium-iron.

Gümbel\index{Gümbel}: ``On the Stone Meteorites Found in Bavaria'', \emph{Proceedings of the Mathematical Physical Science Class of the Royal Academy of Sciences in Munich}, 1878, Issue 1, p. 14, \emph{et seq}. In the description of the meteorites of Eichstädt\index{meteorite!Eichstädt} and Schöneberg\index{meteorite!Schöneberg}, he mentions ``mesh-structure'' (p. 27. 46). However, he also speaks of ``descendants of larger broken chondrules'' (p. 28). The important section of his observation is on page 58, which follows here:
...
An excellent, highly accurate physical description of these chondrites is given by [Karl Wilhelm von] Gümbel\index{Gümbel} in his instructive essay: ``About the Stone Meteorites Found in Bavaria'' (\emph{Minutes of the Mathematical-Physical Class of the Royal Bavarian Academy of Sciences in Munich}, 1878), from which some sentences may be quoted here to mark the position that science has currently taken on this issue.
...
We may apply to all these alleged crinoids the same remarks we have already made about the corals. \emph{All of them, as they are a whole, possess precisely the same form in rounded sheets, like the corals, like the Urania}. We could copy exactly the contours of the \emph{Urania}\index{Urania} sponge\index{sponge} and apply them to a coral\index{coral}, to a crinoid, without having the need for the slightest alteration. We present a figure of a Hahnian crinoid (Fig. 2), drawn from a distinct chamber in a thin section of the Vouillé meteorite, which Mr. Daubrée has permitted us to use with his habitual helpfulness. This figure is even more complete than any of the figures photographed in such large numbers by Mr. Hahn --- were we observe exactly the same rounded leaf form. However, admittedly, we are not in any way certain if our determination is right --- is it an \emph{Urania}\index{Urania}, a coral, a crinoid\index{crinoid}? We willingly leave the choice to the reader --- what we are certain of, in any event, is that this is a section of a complete chondrule, within which are embedded fragments of meteoritic iron in places.
...
\caption{Observations of spicules, feather type patterns within a secondary material inside a single ellipsoid inclusion of perfectly clear olivine\index{olivine} with additional bubble trails in curious locations. Northwest Africa 2892.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig1.jpg}
\caption{Higher magnification view of Figure 1.}
\centering
\end{figure}
\clearpage
...
\caption{Cropped section from Figure 2.}
\centering
\end{figure}
\clearpage
...
\caption{Sharp, barbed spicules similar to some radiolarians, a unique grated oval structure attached to an appendage. Northwest Africa 11344.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig12.jpg}
\caption{Higher magnification view of Figure 4 showing spicules.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig5a.png}
\caption{Cropped image of Figure 5.}
\centering
\end{figure}
\clearpage
...
\caption{Resembles Figure 1 in Table 8 of Hahn's work and Figure 1 of Karsten's\index{Karsten} work. Northwest Africa 2892.}
\centering
\end{figure}
\clearpage
...
\caption{Numerous parallel and crossing tubular structures from Figure 7.}
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig32.jpg}
\caption{Numerous parallel and curved tubular structures from Figure 7.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig3.jpg}
\caption{Interesting patterns. Northwest Africa 4910.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig4.jpg}
\caption{Greyish secondary material in peculiar patterns within the chondrule.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig13.jpg}
\caption{Feathery, skeletal looking forms. Northwest Africa 8773.}
\centering
\end{figure}
\clearpage
...
\caption{Skeletal looking forms. Saratov.}
\centering
\end{figure}
\clearpage
...
\caption{Interesting patterns with spicules at high magnification. Saratov.}
\centering
\end{figure}
\clearpage
...
\caption{Two fascinating forms in cross polarized light. Northwest Africa 5930.}
\centering
\end{figure}
\clearpage
...
\caption{Higher magnification view of leftmost structure in Figure 15.}
\centering
\end{figure}

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig10.jpg}
\caption{Higher magnification view of rightmost structure in Figure 15.}
\centering
\end{figure}
\clearpage
...
\caption{Interesting structure similar to those in Figure 15. Northwest Africa 5930.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig9.jpg}
\caption{Higher magnification view of rightmost structure in Figure 18.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig29.jpg}
\caption{Curious structure in Allende.}
\centering
\end{figure}
\clearpage
...
\caption{Higher magnification view of Figure 20.}
\centering
\end{figure}
\clearpage
...
\caption{Fascinating inclusion with crossing. Northwest Africa 2224.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig25.jpg}
\caption{Characteristic pattern form. Northwest Africa 2224.}
\centering
\end{figure}
\clearpage
...
\caption{Characteristic pattern form. Northwest Africa 11344.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig15.jpg}
\caption{Arrangement of structures in Aba Panu similar to Figure 2 of Weinland's 1882 work.}
\centering
\end{figure}
\clearpage
...
\caption{Surface photo showing inclusion with peculiar characteristics. Northwest Africa 6472.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig16.jpg}
\caption{Higher magnification view of Figure 26.}
\centering
\end{figure}
\clearpage
...
\caption{Surface photo showing pacman type characteristics. Northwest Africa 6472.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig18.jpg}
\caption{Surface photo showing inclusion with bilaterally symmetric shape. Northwest Africa 6472.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig19.jpg}
\caption{Surface photo showing peculiar characteristics. Northwest Africa 2224.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig20.jpg}
\caption{High magnification view of a carbonaceous inclusion. Kainsaz.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig21.jpg}
\caption{Triangular shaped inclusion with grated mouth hole resembling sea urchin larva structure. Northwest Africa 4910.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig22.jpg}
\caption{High magnification view of a carbonaceous inclusion containing interesting diatom-like patterns. Moss.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig23.jpg}
\caption{High magnification view of a carbonaceous inclusion containing interesting patterns. Kainsaz.}
\centering
\end{figure}
\clearpage

\begin{figure}[b]
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/solar/fig24.jpg}
\caption{A unicum, this inclusion contained forms and structures that were characteristically different than most. Northwest Africa 2224.}
\centering
\end{figure}
\clearpage
\pagestyle{plain}
