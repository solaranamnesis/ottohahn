...
\usepackage[top=76mm, bottom=95mm, outer=68mm, inner=64mm]{geometry}
...
\AddToShipoutPictureBG{\includegraphics[width=\paperwidth,height=\paperheight]{thinsection01.jpg}}
\def\arraystretch{1.15}
\renewcommand{\thefigure}{{\arabic{figure}}}

\renewcommand\thefootnote{{\bfseries\scriptsize\color{customColor}{\arabic{footnote}}}}
\let\oldfootnote\footnote
    \renewcommand{\footnote}[1]{\oldfootnote{{\bfseries\scriptsize\color{customColor}#1}}}
\bfseries
...
\scriptsize
    ...
    \begin{tabular}{ |p{1.5cm}|p{0.8cm}|p{0.8cm}|p{0.8cm}|p{0.8cm}|p{0.8cm}| }
        \hline
        Substances & \scriptsize{Bulk Analysis} & \scriptsize{57.69\% decomposable in hydrochloric acid individually} & \scriptsize{57.69\% decomposable in hydrochloric acid in \%} & \scriptsize{42.31\% not decomposable in hydrochloric acid\footnote{Without chromite and tin(II) oxide.} individually} & \scriptsize{42.31\% not decomposable in hydrochloric acid in \%}\\\hline
...
\begin{center}
\tiny
    \begin{tabular}{|l|p{1.7cm}|p{1.5cm}|p{1.5cm}|}
        \hline
