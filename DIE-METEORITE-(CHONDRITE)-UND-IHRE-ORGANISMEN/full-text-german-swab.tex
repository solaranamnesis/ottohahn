...
"`Der gew"ohnliche Typus der Meteorit\index{Meteorit} von steiniger Beschaffenheit ist soweit "uberwiegend derjenige der sog. Chondrite und die Zusammensetzung sowie die Struktur aller dieser Steine so sehr "ubereinstimmend, dass wir den gemeinsamen Ursprung und die uranf"angliche Zusammengeh"origkeit aller dieser Art Meteorit\index{Meteorit} --- wenn nicht aller --- wohl nicht weiter in Zweifel ziehen k"onnen.
...
\clearpage
\section{\swabfamily{Die Organische Natur der Chondrite}}
...
\paragraph{}
Anschlie"send an die bisherigen Resultate lie"sen sich auch f"ur die Erdbildung einige Schl"usse ziehen. H"ochst wahrscheinlich zeigt der Erddurchschnitt dieselbe Gesteins-Reihenfolge, wie die Meteorit\index{Meteorit}, welche vom Eisen zum Pallasite (Olivin mit Eisen), von da zu Olivin-, Enstatit-, (Feldspat)-Gestein "ubergehen.
