...
\makeindex[columns=2, title=\swabfamily{Alphabetischer Index}, intoc]
\usepackage{sectsty}
\usepackage[titles]{tocloft}
...
\renewcommand{\cftfigfont}{\swabfamily}
\renewcommand{\cftfigpagefont}{\swabfamily}
...
\begin{titlepage} % Suppresses headers and footers on the title page
	...
	{\Huge Die Meteorit (Chondrit)\\ und\\ ihre Organismen\\} % Title
	...
	{\Large Dargestellt und Beschrieben\\ von\\ \scshape\Large Dr. Otto Hahn\\} % Subtitle or further description
	
	\vspace*{1\baselineskip} % Whitespace under the subtitle
	
    {\large 32 Tafeln mit 142 Abbildungen} % Subtitle or further description
	...
	{\small CC0 1.0 Universell } % Publisher
\end{titlepage}
...
Ich halte es f"ur irdisch --- halte es f"ur die tiefste Schichte unserer Erde, der Olivinschichte, die unter dem Granit lagert, angeh"orend. Ich nenne die urspr"ungliche Schichte Olivin-Formation. Da das Gestein einem Meteorit\index{Meteorit} sehr "ahnlich ist, lag es nahe, dasselbe f"ur einen solchen zu erkl"aren. Die Gr"unde, warum ich es nicht f"ur meteoritisch, sondern f"ur den wahren Erdkern halte, sind in diesem Buche niedergelegt.
...
Ich muss dies noch n"aher begr"unden. Die Vergleichung der Gesteine der Erde und der Meteorit\index{Meteorit} zeigt, dass der Chondrit, wenigstens nach seiner chemischen Beschaffenheit, seine allern"achsten Verwandten auf der Erde hat.
...
Dies sind die Schlussfolgerungen aus der Untersuchung "uber die Meteorit\index{Meteorit} f"ur unsere Erdbildung. Ungleich bedeutender aber sind die Tatsachen, welche die Astronomie daraus ableiten kann.
...
\clearpage
\subsection{\swabfamily{Die Bisherigen Ansichten "uber die Meteorit\index{Meteorit}}}
\paragraph{}
Es folgt nun zun"achst eine kurze Darstellung der bisherigen Ansichten "uber die Entstehung und Natur der Meteorit\index{Meteorit}.

Nur die morphologischen Arbeiten "uber einzelne Meteorit\index{Meteorit}, von der Zeit an, als man das Mikroskop in der Geologie anzuwenden begann, sollen aufgez"ahlt werden.

Was das Mikroskop bis jetzt zur Deutung der Meteorit\index{Meteorit} geliefert hat, das ist, abgesehen von den vergr"o"serten Olivinkristallen in [Nikolai Ivanovich] Kokscharow's \emph{Mineralien Russlands VI} Band S. 4, in folgenden Schriften enthalten:
\large
\begin{enumerate}
\item Gustav Tschermak: "`die Tr"ummerstruktur der Meteoriten von Orvinio\index{Meteorit!Orvinio} und Chantonnay"', vorgelegt in der Sitzung der K. Akademie der Wissenschaften (Wien) am 12. November 1874. (XX. Band der Sitzungsberichte der K. Akademie der Wissenschaften, I. Abteilung, November-Heft 1874. Mit 2 Tafeln.)
...
"`Der gew"ohnliche Typus der Meteorit\index{Meteorit} von steiniger Beschaffenheit ist soweit "uberwiegend derjenige der sog. Chondrit und die Zusammensetzung sowie die Struktur aller dieser Steine so sehr "ubereinstimmend, dass wir den gemeinsamen Ursprung und die uranf"angliche Zusammengeh"origkeit aller dieser Art Meteorit\index{Meteorit} --- wenn nicht aller --- wohl nicht weiter in Zweifel ziehen k"onnen.

"`Der Umstand, dass sie s"amtlich in h"ochst unregelm"a"sig geformten St"uckchen in unsere Atmosph"are gelangen --- abgesehen von dem Zerspringen innerhalb der letzteren in mehrere Fragmente, was zwar h"aufig vorkommt, aber doch nicht in allen F"allen angenommen werden kann, namentlich nicht, wenn durch direkte Beobachtung das Fallen nur eines St"uckes konstatiert ist, --- l"asst weiter schlie"sen, dass sie bereits in regellos zertr"ummerten St"ucken als Abk"ommlinge von einem einzigen gr"o"seren Himmelsk"orper ihre Bahnen im Himmelsraume ziehen und in ihrer Zerstreutheit einzeln zuweilen in das Attraktionsbereich der Erde geraten zur Erde niederfallen. Der Mangel urspr"unglicher, lavaartiger, amorpher Bestandteile in Verbindung mit der "au"sern unregelm"a"sigen Form d"urfte von geo- oder kosmologischen Standpunkte aus die Annahme ausschlie"sen, dass diese Meteorit\index{Meteorit} Ausw"urfe von Mondvulkanen, wie vielfach behauptet wird, sein k"onnen."'

G"umbel fasst, nachdem er die Meteorit\index{Meteorit} in die Olivingesteine unserer Erde eingestellt hat, seine Ansicht hinsichtlich der Entstehung (S. 64) in den Satz zusammen:

"`Es scheinen daher die Meteorit\index{Meteorit} aus einer Art erstem Verschlackungsprozess der Himmelsk"orper, aber da sie metallisches Eisen enthalten --- bei Mangel von Sauerstoff und Wasser hervorgegangen zu sein."'
...
\begin{center}
\begin{tabular}{ l r }
 Tabor, B"ohmen [Tschechische Republik] & July 3, 1753\index{Meteorit!Tabor} \\
 Siena, Toskana [Italienische Republik] & June 16, 1794\index{Meteorit!Siena} \\
 L'Aigle, Normandy [Französische Republik] & April 26, 1803\index{Meteorit!L'Aigle} \\
 Weston, Connecticut [Vereinigte Staaten] & December 14, 1807\index{Meteorit!Weston} \\
 Tipperary, Irland & November 23, 1810\index{Meteorit!Tipperary} \\
 Blansko, Br"unn [Tschechische Republik] & November 25, 1833\index{Meteorit!Blansko} \\
 Château-Renard, Loiret [Französische Republik] & July 12, 1841\index{Meteorit!Château-Renard} \\
 Linn [Marion] County, Iowa [Vereinigte Staaten] & February 25, 1847\index{Meteorit!Marion County}\index{Meteorit!Linn} \\
 Cabarras [Monroe] County, North Carolina [Vereinigte Staaten] & October 31, 1849\index{Meteorit!Monroe County}\index{Meteorit!Cabarras} \\
 Mez"o-Madaras [Romania] & September 4, 1852\index{Meteorit!Mez"o-Madaras} \\
 Borkut, Ungarn & October 13, 1852\index{Meteorit!Borkut} \\
 Bremerv"orde, Hannover [Deutschland] & May 13, 1855\index{Meteorit!Bremerv"orde} \\
 Parnallee, Osten Indien [Tamil Nadu] & February 28, 1857\index{Meteorit!Parnallee} \\
 Heredia, Kostarika & April 1, 1857\index{Meteorit!Heredia} \\
 New Concord, Ohio [Vereinigte Staaten] & May 1, 1860\index{Meteorit!New Concord} \\
 Knyahinya, Ungarn & June 9, 1866\index{Meteorit!Knyahinya} \\
 Pultusk, Warschau [Republik Polen] & January 30, 1868\index{Meteorit!Pultusk} \\
 Orvinio [Italienische Republik] & August 31, 1872\index{Meteorit!Olvinio} \\
 Simbirsk [Russland] & [1838]\index{Meteorit!Simbirsk} \\
\end{tabular}
\end{center}
\LARGE
\paragraph{}
...
\clearpage
\section{\swabfamily{Die Organische Natur der Chondrit}}
\subsection{\swabfamily{Organisch oder Unorganisch?}}
\paragraph{}
...
\clearpage
\subsection{\swabfamily{Die Einzelnen Formen: Schw"amme --- \emph{Urania}\index{Urania}}}
\paragraph{}
...
\clearpage
\subsection{\swabfamily{Die Einzelnen Formen: Schw"amme --- Nadel-Schw"amme}}
\paragraph{}
...
\clearpage
\subsection{\swabfamily{Die Einzelnen Formen: Die Korallen\index{koralle}}}
\paragraph{}
...
\clearpage
\subsection{\swabfamily{Die Einzelnen Formen: Crinoiden\index{Crinoid}}}
\paragraph{}
...
\clearpage
\subsection{\swabfamily{Alles Leben}}
\paragraph{}
...
\clearpage
\subsection{\swabfamily{Stein im Stein}}
\paragraph{}
...
\clearpage
\subsection{\swabfamily{Fortpflanzung}}
\paragraph{}
...
\clearpage
\subsection{\swabfamily{Entwickelung}}
\paragraph{}
...
\clearpage
\section{\swabfamily{Das Meteoreisen\index{Meteorit!eisen}}}
\paragraph{}
...
\clearpage
\section{\swabfamily{Das Eisen von Ovifak\index{Ovifak}}}
\paragraph{}
...
\clearpage
\section{\swabfamily{Schlussfolgerungen}}
\subsection{\swabfamily{Ursprung der Meteorit\index{Meteorit}}}
\paragraph{}
...
\clearpage
\subsection{\swabfamily{Die Erdbildung}}
\paragraph{}
Anschlie"send an die bisherigen Resultate lie"sen sich auch f"ur die Erdbildung einige Schl"usse ziehen. H"ochst wahrscheinlich zeigt der Erddurchschnitt dieselbe Gesteins-Reihenfolge, wie die Meteorit\index{Meteorit}, welche vom Eisen zum Pallasit (Olivin mit Eisen), von da zu Olivin-, Enstatit-, (Feldspat)-Gestein "ubergehen.
...
\clearpage
\subsection{\swabfamily{Die Zukunft Unseres Planeten}}
\paragraph{}
Der Fall von Planeten-Tr"ummern auf unsere Erde, (f"ur diesen Ursprung der Meteorit\index{Meteorit} sprechen die meisten Gr"unde) lie"se ein mechanisches Enden, einen gewaltsamen Tod auch f"ur unsere Erde f"urchten. Geschah es jenem oder jenen Planeten, von welchen die Meteorit\index{Meteorit} herr"uhren, dass sie zertr"ummert wurden, und zwar wurden sie es wohl nicht durch eine Kraft von innen, sondern durch Ansto"s von au"sen: so m"ussten wir darauf gefasst sein, dass auch unserer Erde einmal dieses Schicksal widerfahren werde, wenigstens drohte es uns. Ich muss es den Astronomen "uberlassen, sich und ihre Zeitgenossen dar"uber zu tr"osten.
...
\clearpage
\section{\swabfamily{Erkl"arung der Tafeln}}
\subsection{\swabfamily{Vorbemerkung}}
\paragraph{}
...
\clearpage
\subsection{\swabfamily{Tafelverzeichniss}}
\begin{enumerate}
